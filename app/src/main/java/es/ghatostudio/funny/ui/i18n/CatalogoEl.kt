        ...
        textos =
            mapOf<Clave, String>(
                ...
                MODO_SOLITARIO_DETALLE to
                    "Εσύ εναντίον του χρόνου: μια σειρά δοκιμασιών και ένα προσωπικό " +
                ...
                SOLITARIO_SUBTITULO to "Μια σειρά δοκιμασιών. Εσύ εναντίον του χρόνου.",
                ...
                AYUDA_FAQ_2_R to
                    "Ναι: η μονή πρόκληση είναι μια σειρά δοκιμασιών με προσωπικό ρεκόρ. Μπαίνουν " +
                    "μόνο τα παιχνίδια που δεν χρειάζονται κοινό.",
                ...
                TOUR_MODOS_TEXTO to
                    ...
                    "έως 8. Και η μονή πρόκληση είναι μια σειρά δοκιμασιών εναντίον του χρόνου, " +
