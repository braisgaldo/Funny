...
val Fondo: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.fondo
val FondoAlto: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.fondoAlto
val Superficie: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.superficie
val SuperficieAlta: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.superficieAlta
val Primario: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.primario
val SobrePrimario: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.sobrePrimario
val Acento: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.acento
val SobreAcento: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.sobreAcento
val TextoFuerte: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.textoFuerte
val TextoTenue: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.textoTenue
val Exito: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.exito
val SobreExito: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.sobreExito
val Fallo: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.fallo
val SobreFallo: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.sobreFallo
val Contorno: Color @Composable @ReadOnlyComposable get() = LocalPaleta.current.contorno
...
private val TipografiaFunny = Typography(
...
private fun esquemaDe(p: Paleta) = if (p.esOscuro) {
    darkColorScheme(
        primary = p.primario,
