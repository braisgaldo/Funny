 ...
 */
internal val catalogoCastellano = Catalogo(
    idioma = Idioma.CASTELLANO,
    textos = mapOf<Clave, String>(
        // ------------------------------------------------------------ comunes
        ...
        CAFE_SIN_DESBLOQUEOS to
            "No desbloquea nada: Funny está entera y siempre lo estará.",
        ...
        AYUDA_PARTIDA_2 to "Cada equipo o jugador tiene una ficha y todos salen de la SALIDA.",
        AYUDA_PARTIDA_3 to "En su turno se tira el dado y se avanza de 1 a 3 casillas.",
        AYUDA_PARTIDA_4 to "La casilla en la que caes decide la prueba. Si la superas, te quedas; si no, vuelves.",
        ...
        AYUDA_UN_MOVIL_2 to "En mímica, tabú, dibujo, canta y desafío solo mira quien actúa.",
        ...
        SALON_ERROR_UBICACION to "Enciende la ubicación: Android la exige para buscar por Bluetooth.",
