 ...
 */
internal val catalogoIngles = Catalogo(
    ...
    textos = mapOf<Clave, String>(
        ...
        CAFE_SIN_DESBLOQUEOS to
            "It unlocks nothing: Funny is complete and always will be.",
        ...
        AYUDA_UN_MOVIL_2 to "In mime, taboo, drawing, singing and dares, only the performer looks.",
