        ...
        textos =
            mapOf<Clave, String>(
                ...
                MODO_SOLITARIO_DETALLE to
                    "Ты против часов: серия заданий подряд и личный рекорд, который надо " +
                ...
                SOLITARIO_SUBTITULO to "Серия заданий. Ты против часов.",
                ...
                AYUDA_FAQ_2_R to
                    "Да: одиночный вызов — это серия заданий подряд с личным рекордом. Участвуют " +
                ...
                TOUR_MODOS_TEXTO to
                    ...
                    "одиночный вызов — это серия заданий против часов, в одиночку, с личным " +
                    "рекордом.",
